...
var DefaultCodecs = []codecs.Codec{new(codecs.JSON)}
...
// marshalled instead.
func (s *WebCodecService) MarshalWithCodec(codec codecs.Codec, object interface{}, options map[string]string) (interface{}, error) {
	...
	return codec.Marshal(publicData)
}
