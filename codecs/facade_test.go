...
import (
	...
	"github.com/nelsam/silverback/codecs/test"
...
func TestPublicData(t *testing.T) {
	...
	public, err := PublicData(o, map[string]string{})
...
func TestPublicDataMap(t *testing.T) {
	...
	public, err := PublicDataMap(o, map[string]string{})
...
func TestPublicData_WithArray(t *testing.T) {
	...
	public, err := PublicData(arr, map[string]string{})
...
func TestPublicData_WithError(t *testing.T) {
	...
	_, err := PublicData(o, map[string]string{})
...
func TestPublicData_WithRecursion_WithObjects(t *testing.T) {
	...
	args := map[string]string{constants.OptionKeyClientCallback: "~d"}
